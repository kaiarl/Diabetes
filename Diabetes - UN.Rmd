...
levels(diabetes$Outcome)
```
The data cleaning will ensure ggplot will color correctly for variabel Outcome
...
Insignificant p-value so we fail to reject the null and favor the reduced model. 
